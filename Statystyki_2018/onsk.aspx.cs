...
namespace stat2018
{
    ...
    public partial class onsk : System.Web.UI.Page
    {
        ...
        const string tenPlik= "onsk.aspx";
        ...
        protected void makeHeader()
        {
            ...
            dT_02.Rows.Add(new Object[] { "1", "K-publiczne", "1", "1" });
            dT_02.Rows.Add(new Object[] { "1", "K -wyrok łączny", "1", "1" });
            dT_02.Rows.Add(new Object[] { "1", "K-skarb.", "1", "1" });
            dT_02.Rows.Add(new Object[] { "1", "K-pryw.", "1", "1" });
            dT_02.Rows.Add(new Object[] { "1", "K tryb. 55 kpk", "1", "1" });
            dT_02.Rows.Add(new Object[] { "1", "K razem", "1", "1" });
            dT_02.Rows.Add(new Object[] { "1", "Ko", "1", "1" });
            dT_02.Rows.Add(new Object[] { "1", "Kp", "1", "1" });
            dT_02.Rows.Add(new Object[] { "1", "Kop", "1", "1" });
            dT_02.Rows.Add(new Object[] { "1", "W", "1", "1" });
            ...
            dT_03.Rows.Add(new Object[] { "2", "K-publ", "1", "2" });
            dT_03.Rows.Add(new Object[] { "2", "K-wyrok łączny", "1", "2" });
            dT_03.Rows.Add(new Object[] { "2", "K-skarb.", "1", "2" });
            dT_03.Rows.Add(new Object[] { "2", "K pryw.", "1", "2" });
            dT_03.Rows.Add(new Object[] { "2", "K Tryb 55 kpk", "1", "2" });
            dT_03.Rows.Add(new Object[] { "2", "K Razem", "1", "2" });
            dT_03.Rows.Add(new Object[] { "2", "Ko", "1", "2" });
            dT_03.Rows.Add(new Object[] { "2", "Kop", "1", "2" });
            dT_03.Rows.Add(new Object[] { "2", "W", "1", "2" });
            dT_03.Rows.Add(new Object[] { "2", "Ko", "1", "2" });
            ...
            dT_03.Rows.Add(new Object[] { "3", "Wpływ", "12", "1" });
            ...
            dT_04.Rows.Add(new Object[] { "2", "K-publ", "1", "2" });
            dT_04.Rows.Add(new Object[] { "2", "K-wyrok łączny  ", "1", "2" });
            dT_04.Rows.Add(new Object[] { "2", "K-skarb.", "1", "2" });
            dT_04.Rows.Add(new Object[] { "2", "K pryw.", "1", "2" });
            dT_04.Rows.Add(new Object[] { "2", "K Tryb 55 kpk ", "1", "2" });
            dT_04.Rows.Add(new Object[] { "2", "K Razem ", "1", "2" });
            dT_04.Rows.Add(new Object[] { "2", "Ko ", "1", "2" });
            dT_04.Rows.Add(new Object[] { "2", "Kp ", "1", "2" });
            dT_04.Rows.Add(new Object[] { "2", "Kop", "1", "2" });
            dT_04.Rows.Add(new Object[] { "2", "W", "1", "2" });
            ...
            dT_04.Rows.Add(new Object[] { "3", "Załatwienia", "12", "1" });
            ...
            dT_05.Rows.Add(new Object[] { "1", "K-publiczne", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "K -wyrok łączny", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "K-skarb.", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "K-pryw.", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "K tryb. 55 kpk", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "K razem", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "Ko", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "Kp", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "Kop", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "W", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "Razem", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "W tym 3-6 miesięcy", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "6-12 miesięcy", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "Powyżej 12 miesięcy", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "Powyżej 24 miesięcy", "1", "1" });
            dT_05.Rows.Add(new Object[] { "2", "L.p.", "1", "2" });
            dT_05.Rows.Add(new Object[] { "2", "Imię i Nazwisko", "1", "2" });

            dT_05.Rows.Add(new Object[] { "2", "Pozostało na następny miesiąc", "15", "1" });
            ...
            // dt_09.Rows.Add(new Object[] { "2", "Imię i Nazwisko", "1", "2" });
        ...
        protected void przemiel()
        {
            ...
            try
            {
                ...
                txt = txt + cl.generuj_dane_do_tabeli_wierszy(DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text), yyx, 10);
                ...
                dt1 = cl.generuj_dane_do_tabeli_wierszy_przestawnych1(DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text), yyx, 1000, 1);
                dt3 = cl.generuj_dane_do_tabeli_wierszy_przestawnych1(DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text), yyx, 1002, 1);
                ...
                dt2 = cl.generuj_dane_do_tabeli_przestawnych(int.Parse((string)Session["id_dzialu"]), 1001, DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text));
                dt4 = cl.generuj_dane_do_tabeli_przestawnych(int.Parse((string)Session["id_dzialu"]), 1003, DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text));
                ...
                dt1 = cl.generuj_dane_do_tabeli_wierszy_przestawnych1(DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text), yyx, 2000, 1);
                dt2 = cl.generuj_dane_do_tabeli_przestawnych(int.Parse((string)Session["id_dzialu"]), 2001, DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text));
                dt3 = cl.generuj_dane_do_tabeli_wierszy_przestawnych1(DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text), yyx, 2002, 1);
                dt4 = cl.generuj_dane_do_tabeli_przestawnych(int.Parse((string)Session["id_dzialu"]), 2003, DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text));
                ...
                //          GridView12.ShowHeader = false;
                //        GridView12.DataSourceID = null;
                //      GridView12.AutoGenerateColumns = false;
                //    GridView12.DataSource = dt_all;
                //  GridView12.DataBind();
                ...
                txt = txt + cl.generuj_dane_do_tabeli_(int.Parse((string)Session["id_dzialu"]), 8, DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text));
                //  txt = txt + cl.generuj_dane_do_tabeli_(int.Parse((string)Session["id_dzialu"]), 10, DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text));
        ...
        protected void makeHeader10(System.Web.UI.WebControls.GridView sender, DataTable dT)
        {
            try
            {
                int row = 0;
                ...
                foreach (DataRow dR in dT.Rows)
                {
                    ...
                    HeaderGridRow.Cells.Add(HeaderCell_(dR[1].ToString().Trim(), int.Parse(dR[2].ToString().Trim()), int.Parse(dR[3].ToString().Trim())));
                    GridView10.Controls[0].Controls.AddAt(0, HeaderGridRow);
                }
            }
            catch
            { } // end of try
        ...
        protected void makeHeader11(System.Web.UI.WebControls.GridView sender, DataTable dT)
        {
            try
            {
                int row = 0;
                ...
                foreach (DataRow dR in dT.Rows)
                {
                    ...
                    HeaderGridRow.Cells.Add(HeaderCell_(dR[1].ToString().Trim(), int.Parse(dR[2].ToString().Trim()), int.Parse(dR[3].ToString().Trim())));
                    GridView11.Controls[0].Controls.AddAt(0, HeaderGridRow);
                }
            }
            catch
            { } // end of try
        }
        protected void makeHeaderPR(System.Web.UI.WebControls.GridView sender, DataTable dT)
        {
            try
            {
                int row = 0;
                ...
                foreach (DataRow dR in dT.Rows)
                {
                    ...
                    HeaderGridRow.Cells.Add(HeaderCell_(dR[1].ToString().Trim(), int.Parse(dR[2].ToString().Trim()), int.Parse(dR[3].ToString().Trim())));
                    GridView13.Controls[0].Controls.AddAt(0, HeaderGridRow);
                }
            }
            catch
            { } // end of try
        ...
        protected void makeHeaderPR2(System.Web.UI.WebControls.GridView sender, DataTable dT)
        {
            try
            {
                int row = 0;
                ...
                foreach (DataRow dR in dT.Rows)
                {
                    ...
                    HeaderGridRow.Cells.Add(HeaderCell_(dR[1].ToString().Trim(), int.Parse(dR[2].ToString().Trim()), int.Parse(dR[3].ToString().Trim())));
                    GridView17.Controls[0].Controls.AddAt(0, HeaderGridRow);
                }
            }
            catch
            { } // end of try
        ...
        protected void makeHeader12(System.Web.UI.WebControls.GridView sender, DataTable dT)
        {
            try
            {
                int row = 0;
                ...
                foreach (DataRow dR in dT.Rows)
                {
                    ...
                    HeaderGridRow.Cells.Add(HeaderCell_(dR[1].ToString().Trim(), int.Parse(dR[2].ToString().Trim()), int.Parse(dR[3].ToString().Trim())));
                    GridView19.Controls[0].Controls.AddAt(0, HeaderGridRow);
                }
            }
            catch
            { } // end of try
        ...
        protected void makeLabels()
        {
            try
            {
                ...
                {
                    // cały miesiąc
                    Label19.Text = "Pozostało z ubiegłego miesiąca za miesiąc " + strMonthName + " " + DateTime.Parse(Date2.Text).Year.ToString() + " roku.";
                    ...
                    Label34.Text = "Pozostało na następny miesiąc w miesiącu:  " + strMonthName + " " + DateTime.Parse(Date2.Text).Year.ToString() + " roku.";
                    Label27.Text = "za miesiąc:  " + strMonthName + " " + DateTime.Parse(Date2.Text).Year.ToString() + " roku.";
                    Label35.Text = "Struktura pozostałości -liczba spraw (w tym zawieszone) w miesiącu:  " + strMonthName + " " + DateTime.Parse(Date2.Text).Year.ToString() + " roku.";
