<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="otrc.aspx.cs" Inherits="stat2018.otrc"  MaintainScrollPositionOnPostback="true" %>
   ...
   <div id="zalatwienia"  class="page-break"> 
    ...
    <asp:Label ID="Label19" runat="server"></asp:Label>
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataSourceID="dane_do_tabeli_2" OnRowCreated="grvMergeHeader_RowCreated" 
