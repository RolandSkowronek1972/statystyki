<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="aoppStary.aspx.cs" Inherits="stat2018.aoppStary" %>
...
<asp:GridView ID="gwTabela1" runat="server" OnRowCreated="naglowekTabeli_gwTabela1"  AutoGenerateColumns="False"  OnRowDataBound="stopkaTabeli_gwTabela1"  Width = "100%" ShowHeader = "False" ShowFooter = "True"  >
    ...
    <asp:BoundField DataField = "id" HeaderText = "L.p." SortExpression = "id" >
       ...
       <asp:TemplateField HeaderText = "d_270" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!270!7"%>')" ><asp:Label ID = "Label_tabela1370" runat = "server" Text = '<%# Eval("d_270")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_271" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!271!7"%>')" ><asp:Label ID = "Label_tabela1371" runat = "server" Text = '<%# Eval("d_271")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_272" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!272!7"%>')" ><asp:Label ID = "Label_tabela1372" runat = "server" Text = '<%# Eval("d_272")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_273" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!273!7"%>')" ><asp:Label ID = "Label_tabela1373" runat = "server" Text = '<%# Eval("d_273")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_274" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!274!7"%>')" ><asp:Label ID = "Label_tabela1374" runat = "server" Text = '<%# Eval("d_274")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_275" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!275!7"%>')" ><asp:Label ID = "Label_tabela1375" runat = "server" Text = '<%# Eval("d_275")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_276" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!276!7"%>')" ><asp:Label ID = "Label_tabela1376" runat = "server" Text = '<%# Eval("d_276")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_277" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!277!7"%>')" ><asp:Label ID = "Label_tabela1377" runat = "server" Text = '<%# Eval("d_277")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_278" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!278!7"%>')" ><asp:Label ID = "Label_tabela1378" runat = "server" Text = '<%# Eval("d_278")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_279" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!279!7"%>')" ><asp:Label ID = "Label_tabela1379" runat = "server" Text = '<%# Eval("d_279")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_280" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!280!7"%>')" ><asp:Label ID = "Label_tabela1380" runat = "server" Text = '<%# Eval("d_280")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_281" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!281!7"%>')" ><asp:Label ID = "Label_tabela1381" runat = "server" Text = '<%# Eval("d_281")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_282" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!282!7"%>')" ><asp:Label ID = "Label_tabela1382" runat = "server" Text = '<%# Eval("d_282")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_283" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!283!7"%>')" ><asp:Label ID = "Label_tabela1383" runat = "server" Text = '<%# Eval("d_283")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_284" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!284!7"%>')" ><asp:Label ID = "Label_tabela1384" runat = "server" Text = '<%# Eval("d_284")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_285" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!285!7"%>')" ><asp:Label ID = "Label_tabela1385" runat = "server" Text = '<%# Eval("d_285")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
       <asp:TemplateField HeaderText = "d_286" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!286!7"%>')" ><asp:Label ID = "Label_tabela1386" runat = "server" Text = '<%# Eval("d_286")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "col_80_fest"/>
                </asp:TemplateField>
        </Columns>
