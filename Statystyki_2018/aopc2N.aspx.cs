...
namespace stat2018
{
    public partial class aopc2N : System.Web.UI.Page
    {
        ...
        private const string tenPlik = "aopc2N.aspx";
        ...
        protected void tabela_1()
        {
            ...
            DataTable tabelka01 = dr.konwertujNaPrzecinek(dr.generuj_dane_do_tabeli_sedziowskiej_2018(int.Parse(idDzialu), 1, Date1.Date, Date2.Date, 300, tenPlik));
            ...
            for (int j = 0; j < 7; j++)
            {
                kolumna_wplyw01.Columns.Add(DevExpressXXL.kolumnaDoTabeli(tekstydoWplyw[j], "d_" + (j + 2).ToString("D2"), idDzialu, "", false, szerokoscKolumny));
            }
            ...
            do
            {
                ...
                GridViewDataTextColumn d1 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_" + (i - 1 + 8).ToString("D2"), idDzialu, "", false, szerokoscKolumny);
                GridViewDataTextColumn d2 = DevExpressXXL.kolumnaDoTabeli("na posie- dzenie", "d_" + ((i + 8)).ToString("D2"), idDzialu, "", false, szerokoscKolumny);
            ...
            do
            {
                ...
                GridViewDataTextColumn d1 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_" + (i - 1 + 22).ToString("D2"), idDzialu, "", false, szerokoscKolumny);
                GridViewDataTextColumn d2 = DevExpressXXL.kolumnaDoTabeli("na posie- dzenie", "d_" + ((i + 22)).ToString("D2"), idDzialu, "", false, szerokoscKolumny);
                GridViewBandColumn D3 = DevExpressXXL.GetBoundColumn(tekstydoWplyw[(i / 2) - 1]);
            ...
            for (int j = 0; j < 7; j++)
            {
                kolumna_ZALATWIENIA.Columns.Add(DevExpressXXL.kolumnaDoTabeli(tekstydoWplyw[j], "d_" + (j + 37).ToString("D2"), idDzialu, "", false, szerokoscKolumny));
            }
            ...
            sesjeOdbyte.Columns.Add(DevExpressXXL.kolumnaDoTabeli("ogółem", "d_44", idDzialu, "", false, szerokoscKolumny));

            GridViewBandColumn zTego = DevExpressXXL.GetBoundColumn("z tego");

            zTego.Columns.Add(DevExpressXXL.kolumnaDoTabeli("rozprawy", "d_45", idDzialu, "", false, szerokoscKolumny));
            zTego.Columns.Add(DevExpressXXL.kolumnaDoTabeli("posie- dzenia", "d_46", idDzialu, "", false, szerokoscKolumny));
            ...
            sesjeOdbyte2.Columns.Add(DevExpressXXL.kolumnaDoTabeli("ogółem", "d_47", idDzialu, "", false, szerokoscKolumny));

            GridViewBandColumn zTego2 = DevExpressXXL.GetBoundColumn("z tego");

            zTego2.Columns.Add(DevExpressXXL.kolumnaDoTabeli("rozprawy", "d_48", idDzialu, "", false, szerokoscKolumny));
            zTego2.Columns.Add(DevExpressXXL.kolumnaDoTabeli("posie- dzenia", "d_49", idDzialu, "", false, szerokoscKolumny));
            ...
            ASPxGridView1.Columns.Add(DevExpressXXL.kolumnaDoTabeli("Liczba odroczonych publikacji orzeczeń", "d_50", idDzialu, "", false, szerokoscKolumny));
            ...
            LiczbaOdroczonychSpraw.Columns.Add(DevExpressXXL.kolumnaDoTabeli("z terminem", "d_51", idDzialu, "", false, szerokoscKolumny));
            LiczbaOdroczonychSpraw.Columns.Add(DevExpressXXL.kolumnaDoTabeli("bez wyznaczonego terminu", "d_52", idDzialu, "", false, szerokoscKolumny));
            LiczbaOdroczonychSpraw.Columns.Add(DevExpressXXL.kolumnaDoTabeli("OGÓŁEM (wraz z publikacją orzeczeń)", "d_53", idDzialu, "", false, szerokoscKolumny));
            ...
            for (int j = 0; j < 7; j++)
            {
                kolumna_PozostaloscNaNastępny.Columns.Add(DevExpressXXL.kolumnaDoTabeli(tekstydoWplyw[j], "d_" + (j + 54).ToString("D2"), idDzialu, "", false, szerokoscKolumny));
            }
            ASPxGridView1.Columns.Add(kolumna_ZALATWIENIA);
            ...
            stanSprawZawieszonych.Columns.Add(DevExpressXXL.kolumnaDoTabeli("ogółem", "d_61", idDzialu, "", false, szerokoscKolumny));
            stanSprawZawieszonych.Columns.Add(DevExpressXXL.kolumnaDoTabeli("zakreślonych", "d_62", idDzialu, "", false, szerokoscKolumny));
            stanSprawZawieszonych.Columns.Add(DevExpressXXL.kolumnaDoTabeli("nie- zakreślonych", "d_63", idDzialu, "", false, szerokoscKolumny));
            ...
            for (int j = 0; j < 9; j++)
            {
                kolumna_pozostaloSprawStarych.Columns.Add(DevExpressXXL.kolumnaDoTabeli(tekstydopozostaloSprawStarych[j], "d_" + (j + 64).ToString("D2"), idDzialu, "", false, szerokoscKolumny));
            }
            ...
            for (int j = 0; j < 4; j++)
            {
                kolumna_liczbaSporzadzonychUzasadnien.Columns.Add(DevExpressXXL.kolumnaDoTabeli(tekstydoliczbaSporzadzonychUzasadnien[j], "d_" + (j + 73).ToString("D2"), idDzialu, "", false, szerokoscKolumny));
            }
            ...
            for (int j = 0; j < 8; j++)
            {
                kolumna_poUplywieTerminieuUstawowego.Columns.Add(DevExpressXXL.kolumnaDoTabeli(tekstydo_poUplywieTerminieuUstawowego[j], "d_" + (j + 73).ToString("D2"), idDzialu, "", false, szerokoscKolumny));
            }
            ...
            kolumna_uzasadnieniaWygloszone.Columns.Add(DevExpressXXL.kolumnaDoTabeli("Ogólem", "d_85", idDzialu, "", false, szerokoscKolumny));
            kolumna_uzasadnieniaWygloszone.Columns.Add(DevExpressXXL.kolumnaDoTabeli("w tym w których wpłynął wniosek o transkrypcję", "d_86", idDzialu, "", false, szerokoscKolumny));
            ...
            LiczbaSprawwKtorychProjekt.Columns.Add(DevExpressXXL.kolumnaDoTabeli("razem", "d_87", idDzialu, "", false, szerokoscKolumny));
            LiczbaSprawwKtorychProjekt.Columns.Add(DevExpressXXL.kolumnaDoTabeli("w tym, w których projekt został zaakceptowany przez sędziego", "d_88", idDzialu, "", false, szerokoscKolumny));
            ...
            SkargiNaPrzewlekłosc.Columns.Add(DevExpressXXL.kolumnaDoTabeli("Wpływ", "d_89", idDzialu, "", false, szerokoscKolumny));
            GridViewBandColumn załatwiono = DevExpressXXL.GetBoundColumn("załatwiono");

            załatwiono.Columns.Add(DevExpressXXL.kolumnaDoTabeli("ogółem", "d_90", idDzialu, "", false, szerokoscKolumny));
            załatwiono.Columns.Add(DevExpressXXL.kolumnaDoTabeli("uwzględniono", "d_91", idDzialu, "", false, szerokoscKolumny));
            SkargiNaPrzewlekłosc.Columns.Add(załatwiono);
            SkargiNaPrzewlekłosc.Columns.Add(DevExpressXXL.kolumnaDoTabeli("pozostałość", "d_92", idDzialu, "", false, szerokoscKolumny));
            ...
            mediacje.Columns.Add(DevExpressXXL.kolumnaDoTabeli("WPŁYW liczba sparw, w których strony skierowano do mediacji", "d_93", idDzialu, "", false, szerokoscKolumny));
            GridViewBandColumn rozstrzygniecie = DevExpressXXL.GetBoundColumn("rozstrzygnięcie");

            rozstrzygniecie.Columns.Add(DevExpressXXL.kolumnaDoTabeli("liczba ugód zawartych przed mediatorem", "d_94", idDzialu, "", false, szerokoscKolumny));
            rozstrzygniecie.Columns.Add(DevExpressXXL.kolumnaDoTabeli("w tym zatwierdzono ugodę", "d_95", idDzialu, "", false, szerokoscKolumny));
            mediacje.Columns.Add(rozstrzygniecie);
            ASPxGridView1.Columns.Add(mediacje);

            #endregion mediacje

            ASPxGridView1.Columns.Add(DevExpressXXL.kolumnaDoTabeli("UWAGI", "d_96", idDzialu, "", false, szerokoscKolumny));
            ...
            KolumnaKontrolna.Columns.Add(DevExpressXXL.kolumnaDoTabeli("na rozprawie", "d_97", idDzialu, "", false, szerokoscKolumny));
            KolumnaKontrolna.Columns.Add(DevExpressXXL.kolumnaDoTabeli("na posie- dzenie", "d_98", idDzialu, "", false, szerokoscKolumny));
