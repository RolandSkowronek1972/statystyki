    ...
    public partial class aktk2 : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage MyExcel = new ExcelPackage(existingFile))
            {
                ...
                tabela.tworzArkuszwExcle(MyExcel.Workbook.Worksheets[1], table, 26, 0, 4, true, true, false, false, false);

                // druga
                DataTable table2 = (DataTable)Session["tabelka002"];
                tabela.tworzArkuszwExcle(MyExcel.Workbook.Worksheets[2], table2, 22, 0, 5, true, false, false, false, false);
