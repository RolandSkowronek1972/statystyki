    ...
    public partial class akac : System.Web.UI.Page
    {
        ...
        protected void przemiel()
        {
            ...
            try
            {
                ...
                DataTable tabelka01 = dr.generuj_dane_do_tabeli_wierszy2018(DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text), (string)Session["id_dzialu"],1,15,21,tenPlik);
