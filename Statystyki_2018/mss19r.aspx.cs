    ...
    public partial class mss19r : System.Web.UI.Page
    {
        ...
        protected void odswierz()
        {
            ...
            try
            {
                ...
                TworzTabelizListy(numeryTabel01, PlaceHolder1, path, tabelaDanych);
                ...
                //czesc po mediacjach
                tabelaGlowna.Clear();
                tabelaGlowna.AppendLine(ms.tworztabeleMSS("1.1.2.a", naglowekTabeliDzialu_1_1_2_a(), tabelaBocznaDzialu_1_1_2_a(), tabelaDanych, 3, 29, 3, 9, idWydzialuNumerycznie, true, "Struktura wpływu spraw", tenPlik));
                tabelaGlowna.AppendLine(ms.tworztabeleMSS("1.1.2.b", naglowekTabeliDzialu_1_1_2_b(), tabelaBocznaDzialu_1_1_2_b(), tabelaDanych, 3, 31, 3, 9, idWydzialuNumerycznie, true, "Struktura załatwień spraw", tenPlik));
                ...
                tabelaGlowna.AppendLine(ms.tworztabeleMSS("3", naglowekTabeliDzialu_3(), tabelaBocznaDzialu_3(), tabelaDanych, 2, 4, 1, 8, idWydzialuNumerycznie, true, "Czas trwania mediacji niezakończonych w sprawie od dnia wydania postanowienia o skierowaniu stron do mediacji do ostatniego dnia okresu sprawozdawczego", tenPlik));
                ...
                tabelaGlowna.AppendLine(ms.tworztabeleMSS("5.1", naglowekTabeliDzialu_5_1(), tabelaBocznaDzialu_5_1(), tabelaDanych, 1, 2, 1, 32, idWydzialuNumerycznie, true, "Szczegółowe rozliczenie skargi (Wykaz S)", tenPlik));
      ...
      //          tabelaGlowna.AppendLine(ms.tworztabeleMSS("6.3", naglowekTabeliDzialu_6_3(), tabelaBocznaDzialu_6_3(), tabelaDanych, 2, 3, 3, 12, idWydzialuNumerycznie, true, "Terminowość przyznawania wynagrodzeń za sporządzenie opinii pisemnych i ustnych oraz za stawiennictwo (z wył. tłumaczy przysięgłych)", tenPlik));
        ...
        protected void TworzTabelizListy(string[] listaTabel, PlaceHolder placeHolder, string path, DataTable tabelaDanych)
        {
            ...
            foreach (var item in listaTabel)
            {
                ...
                string kontrolka =  rnd.Next(100).ToString() + i.ToString();
        ...
        private DataTable naglowekTabeliDzialu_1_1_2_a()
        {
            ...
            dT.Clear();
            //                         W  K  CS RS   style"    text"
            dT.Rows.Add(new Object[] { 1, 1, 4, 3, "center", "Wyszczególnienie" });
