<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="okrc.aspx.cs" Inherits="stat2018.okrc" %>
   ...
   <div id="zalatwienia"  class="page-break"> 
    ...
    <asp:Label ID="tabela2Label" runat="server"></asp:Label>
       ...
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        Width="1150px" ShowHeader="False" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
        <Columns>
