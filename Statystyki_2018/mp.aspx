<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="mp.aspx.cs" Inherits="stat2018.mp" %>
...
&nbsp;<asp:Label ID="Label1" runat="server" Text="Ruch spraw w referatach sędziów"></asp:Label>
    ...
    <dx:ASPxGridView ID="ASPxGridView3" runat="server" AutoGenerateColumns="False" Theme="MetropolisBlue" OnSummaryDisplayText="ASPxGridView2_SummaryDisplayText">
                        <SettingsPager PageSize="10100">
                        </SettingsPager>
                        <Settings HorizontalScrollBarMode="Visible" UseFixedTableLayout="True" ShowFooter="True" />
    ...
    <dx:ASPxGridView ID="ASPxGridView4" runat="server" AutoGenerateColumns="False" Theme="MetropolisBlue" OnSummaryDisplayText="ASPxGridView2_SummaryDisplayText">
                        <SettingsPager PageSize="10100">
                        </SettingsPager>
                        <Settings HorizontalScrollBarMode="Visible" UseFixedTableLayout="True" ShowFooter="True" />
    ...
    <dx:ASPxGridView ID="ASPxGridView5" runat="server" AutoGenerateColumns="False" Theme="MetropolisBlue" OnSummaryDisplayText="ASPxGridView2_SummaryDisplayText">
                        <SettingsPager PageSize="10100">
                        </SettingsPager>
                        <Settings HorizontalScrollBarMode="Visible" UseFixedTableLayout="True" ShowFooter="True" />
    ...
    <dx:ASPxGridView ID="ASPxGridView6" runat="server" AutoGenerateColumns="False" Theme="MetropolisBlue" OnSummaryDisplayText="ASPxGridView2_SummaryDisplayText">
                        <SettingsPager PageSize="10100">
                        </SettingsPager>
                        <Settings HorizontalScrollBarMode="Visible" UseFixedTableLayout="True" ShowFooter="True" />
