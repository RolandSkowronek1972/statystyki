...
&nbsp;<asp:Label ID="Label1" runat="server" Text="Ruch spraw"></asp:Label>
 ...
 <table style="width: 100%; "> 
   <tr> 
  <td class="wciecie borderAll" rowspan="3"> 
      Ruch spraw</td>
  ...
  <td class="borderAll center col_50" rowspan="2"> 
      Ua</td>
  <td class="borderAll center col_50" rowspan="2"> 
      Uo</td>
  <td class="borderAll center col_50" rowspan="2"> 
  ...
  <td class="center borderAll col_100" colspan="2"> 
      WSC</td>
       <td class="center borderAll col_50" rowspan="2"> 
      S</td>
       <td class="center borderAll col_50" rowspan="2"> 
      Łącznie</td>
   </tr> 
  ...
  <td class=" borderAll col_50"> 
      skarga kasa-cyjna</td>
  <td class=" borderAll col_50"> 
      skarga o stwier-dzenie niez-godności z prawem </td>
   </tr> 
   <tr> 
 ...
 <td class="center borderAll col_50" style="background-color: #C0C0C0"> 
...
<asp:Label ID="Label7" runat="server" Text="Informacja o ruchu spraw"></asp:Label>
    ...
    <asp:TemplateField HeaderText = "d_26" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!31!2"%>')" ><asp:Label ID = "Label_gwTabela2131" runat = "server" Text = '<%# Eval("d_31")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "borderAll center col_40"/>
                </asp:TemplateField>
             <asp:TemplateField HeaderText = "d_26" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!32!2"%>')" ><asp:Label ID = "Label_gwTabela2132" runat = "server" Text = '<%# Eval("d_32")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "borderAll center col_40"/>
                </asp:TemplateField>
             <asp:TemplateField HeaderText = "d_26" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!33!2"%>')" ><asp:Label ID = "Label_gwTabela2133" runat = "server" Text = '<%# Eval("d_33")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "borderAll center col_40"/>
                </asp:TemplateField>
             <asp:TemplateField HeaderText = "d_26" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!34!2"%>')" ><asp:Label ID = "Label_gwTabela2134" runat = "server" Text = '<%# Eval("d_34")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "borderAll center col_40"/>
                </asp:TemplateField>
                 <asp:TemplateField HeaderText = "d_26" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!35!2"%>')" ><asp:Label ID = "Label_gwTabela2135" runat = "server" Text = '<%# Eval("d_35")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "borderAll center col_40"/>
                </asp:TemplateField>
                 <asp:TemplateField HeaderText = "d_26" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!36!2"%>')" ><asp:Label ID = "Label_gwTabela2136" runat = "server" Text = '<%# Eval("d_36")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "borderAll center col_40"/>
                </asp:TemplateField>
                 <asp:TemplateField HeaderText = "d_26" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!37!2"%>')" ><asp:Label ID = "Label_gwTabela2137" runat = "server" Text = '<%# Eval("d_37")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "borderAll center col_40"/>
                </asp:TemplateField>
                 <asp:TemplateField HeaderText = "d_26" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!38!2"%>')" ><asp:Label ID = "Label_gwTabela2138" runat = "server" Text = '<%# Eval("d_38")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "borderAll center col_40"/>
                </asp:TemplateField>
        </Columns>
       ...
       <asp:TemplateField HeaderText = "d_13" SortExpression = "d_01" > 
        ...
        <asp:TemplateField HeaderText = "d_13" SortExpression = "d_01" > 
          ...
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!16!2"%>')" ><asp:Label ID = "Label_gwTabela3116" runat = "server" Text = '<%# Eval("d_16")%>' CssClass = "normal" ></asp:Label> </a>
               ...
               <asp:TemplateField HeaderText = "d_13" SortExpression = "d_01" > 
                <ItemTemplate >
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!17!2"%>')" ><asp:Label ID = "Label_gwTabela3117" runat = "server" Text = '<%# Eval("d_17")%>' CssClass = "normal" ></asp:Label> </a>
                                   </ItemTemplate>
                   <ItemStyle  CssClass = "borderAll center col_40"/>
                </asp:TemplateField>
        </Columns>
