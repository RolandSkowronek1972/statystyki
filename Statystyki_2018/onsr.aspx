<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="onsr.aspx.cs" Inherits="stat2018.onsr" MaintainScrollPositionOnPostback="true" %>
...
&nbsp;
    ...
    <asp:GridView ID="GridView7" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="d_01" SortExpression="d_01">
                <ItemTemplate>
                        <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_")+ "!"+Eval("id_tabeli") +"!1!1"%>')"><asp:Label ID="Label61" runat="server" Text='<%# Eval("d_01")%>' CssClass="normal"></asp:Label> </a>
  ...
  <ItemStyle  CssClass="col_80" />
            ...
            <asp:TemplateField HeaderText="d_02" SortExpression="d_02">
                <ItemTemplate>
                          <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_")+ "!"+Eval("id_tabeli") +"!2!1"%>')"><asp:Label ID="Label62" runat="server" Text='<%# Eval("d_02")%>' CssClass="normal"></asp:Label> </a>
            ...
            <asp:TemplateField HeaderText="d_03" SortExpression="d_03">
                <ItemTemplate>
          <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_")+ "!"+Eval("id_tabeli") +"!3!1"%>')"><asp:Label ID="Label63" runat="server" Text='<%# Eval("d_03")%>' CssClass="normal"></asp:Label> </a>
            ...
            <asp:TemplateField HeaderText="d_04" SortExpression="d_04">
                <ItemTemplate>
                      <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_")+ "!"+Eval("id_tabeli") +"!4!1"%>')"><asp:Label ID="Label64" runat="server" Text='<%# Eval("d_04")%>' CssClass="normal"></asp:Label> </a>
       </ItemTemplate>
                  <ItemStyle  CssClass="col_80" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="d_05" SortExpression="d_05">
                <ItemTemplate>
                     <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_")+ "!"+Eval("id_tabeli") +"!5!1"%>')"><asp:Label ID="Label65" runat="server" Text='<%# Eval("d_05")%>' CssClass="normal"></asp:Label> </a>
            ...
            <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
                <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_")+ "!"+Eval("id_tabeli") +"!6!1"%>')"><asp:Label ID="Label66" runat="server" Text='<%# Eval("d_06")%>' CssClass="normal"></asp:Label> </a>
             ...
             <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
                   <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_")+ "!"+Eval("id_tabeli") +"!7!1"%>')"><asp:Label ID="Label67" runat="server" Text='<%# Eval("d_07")%>' CssClass="normal"></asp:Label> </a>
             ...
             <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
                <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_")+ "!"+Eval("id_tabeli") +"!8!1"%>')"><asp:Label ID="Label68" runat="server" Text='<%# Eval("d_08")%>' CssClass="normal"></asp:Label> </a>
             ...
             <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
          <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_")+ "!"+Eval("id_tabeli") +"!9!1"%>')"><asp:Label ID="Label69" runat="server" Text='<%# Eval("d_09")%>' CssClass="normal"></asp:Label> </a>
    ...
    <asp:SqlDataSource ID="dane_do_tabeli_6" runat="server" 
        ...
        <Columns>
           ...
           <asp:TemplateField HeaderText="d_01" SortExpression="d_01">
                <ItemTemplate>
                        <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!1!2"%>')"><asp:Label ID="Label71" runat="server" Text='<%# Eval("d_01")%>' CssClass="normal"></asp:Label> </a>
  ...
  <ItemStyle  CssClass="col_69" />
            ...
            <asp:TemplateField HeaderText="d_02" SortExpression="d_02">
                <ItemTemplate>
                          <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!2!2"%>')"><asp:Label ID="Label72" runat="server" Text='<%# Eval("d_02")%>' CssClass="normal"></asp:Label> </a>
            ...
            <asp:TemplateField HeaderText="d_03" SortExpression="d_03">
                <ItemTemplate>
          <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!3!1"%>')"><asp:Label ID="Label73" runat="server" Text='<%# Eval("d_03")%>' CssClass="normal"></asp:Label> </a>
            ...
            <asp:TemplateField HeaderText="d_04" SortExpression="d_04">
                <ItemTemplate>
                      <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!4!2"%>')"><asp:Label ID="Label74" runat="server" Text='<%# Eval("d_04")%>' CssClass="normal"></asp:Label> </a>
       </ItemTemplate>
                  <ItemStyle  CssClass="col_69" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="d_05" SortExpression="d_05">
                <ItemTemplate>
                     <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!5!2"%>')"><asp:Label ID="Label75" runat="server" Text='<%# Eval("d_05")%>' CssClass="normal"></asp:Label> </a>
            ...
            <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
                <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!6!2"%>')"><asp:Label ID="Label76" runat="server" Text='<%# Eval("d_06")%>' CssClass="normal"></asp:Label> </a>
             ...
             <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
                   <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!7!2"%>')"><asp:Label ID="Label77" runat="server" Text='<%# Eval("d_07")%>' CssClass="normal"></asp:Label> </a>
             ...
             <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
                <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!8!2"%>')"><asp:Label ID="Label78" runat="server" Text='<%# Eval("d_08")%>' CssClass="normal"></asp:Label> </a>
             ...
             <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
          <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!9!2"%>')"><asp:Label ID="Label79" runat="server" Text='<%# Eval("d_09")%>' CssClass="normal"></asp:Label> </a>
             ...
             <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
       <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!10!2"%>')"><asp:Label ID="Label710" runat="server" Text='<%# Eval("d_10")%>' CssClass="normal"></asp:Label> </a>
              </ItemTemplate>
                <ItemStyle  CssClass="col_69" />
            </asp:TemplateField>
             <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                <ItemTemplate>
              <a href="javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!11!2"%>')"><asp:Label ID="Label711" runat="server" Text='<%# Eval("d_11")%>' CssClass="normal"></asp:Label> </a>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT ROW_NUMBER() OVER( ORDER BY ident ) AS id, ident, imie, nazwisko, funkcja, stanowisko, d_01, d_02, d_03, d_04, d_05, d_06, d_07, d_08, d_09, d_10, d_11, d_12, d_13, d_14, d_15, d_16, d_17, d_18, d_19, d_20, d_21, d_22, id_tabeli,sesja, id_sedziego FROM tbl_statystyki_tbl_02 WHERE  (id_tabeli = 7) AND (id_dzialu = @id_dzialu) ORDER BY id">
        <SelectParameters>
            <asp:SessionParameter Name="id_dzialu" SessionField="id_dzialu" />
        </SelectParameters>
    </asp:SqlDataSource>
