...
namespace stat2018
{
    ...
    public partial class akak : System.Web.UI.Page
    {
        ...
        public static string tenPlik = "akak.aspx";
        ...
        protected void odswiez()
        {
            ...
            try
            {
                bool debug = cl.debug(int.Parse(yyx));
                Label11.Visible = debug;
                DebugLabel1.Visible = debug;
                DebugLabel2.Visible = debug;
                DebugLabel3.Visible = debug;
                DebugLabel4.Visible = debug;
                DebugLabel5.Visible = debug;
            ...
            catch
            {
                ...
                DebugLabel3.Visible = false;
                DebugLabel4.Visible = false;
                DebugLabel5.Visible = false;
            }
        ...
        protected void makeHeader()
        {
            ...
            dT_02.Rows.Add(new Object[] { "2", "spraw K wielotomowych (pow.5 tomów)", "1", "2", "h" });//

            dT_02.Rows.Add(new Object[] { "2", "K", "1", "2", "h" });//
            dT_02.Rows.Add(new Object[] { "2", "Ko", "1", "2", "h" });//
            dT_02.Rows.Add(new Object[] { "2", "Razem", "1", "2", "h" });//

            dT_02.Rows.Add(new Object[] { "2", "ogółem odroczono na rozprawie", "1", "2", "h" });//
            dT_02.Rows.Add(new Object[] { "2", "% odroczeń", "1", "2", "v" });//
            dT_02.Rows.Add(new Object[] { "2", "w tym ilość odroczeń publikacji wyroków", "1", "2", "v" });//
            ...
            dT_02.Rows.Add(new Object[] { "2", "RAZEM  (r.15 - 18)", "1", "2", "h" });//



            dT_02.Rows.Add(new Object[] { "3", "L.p.", "1", "3", "h" });//
            dT_02.Rows.Add(new Object[] { "3", "Imię i Nazwisko", "1", "3", "h" });//
            dT_02.Rows.Add(new Object[] { "3", "Ilość spraw <br/>w referacie ", "4", "1", "h" });//
            dT_02.Rows.Add(new Object[] { "3", "Liczba wyznaczonych sesji - wokandy", "2", "2", "h" });//

            dT_02.Rows.Add(new Object[] { "3", "Ilość spraw", "3", "1", "h" });//
            dT_02.Rows.Add(new Object[] { "3", "Ilość spraw przerwanych", "1", "3", "h" });//

            dT_02.Rows.Add(new Object[] { "3", "Ilość spraw odroczonych", "3", "1", "h" });//
            dT_02.Rows.Add(new Object[] { "3", "Zdjętych z wokancy", "1", "3", "h" });//
            dT_02.Rows.Add(new Object[] { "3", "Liczba wyznaczonych spraw na posiedzenie", "5", "1", "h" });//
            dT_02.Rows.Add(new Object[] { "3", "Wyznaczono spraw ogółem r.5 +17", "1", "3", "h" });//
            ...
            dT_03.Rows.Add(new Object[] { "1", "o wyrok łączny", "1", "1", "v" });
            dT_03.Rows.Add(new Object[] { "1", "w trybie art..387 kpk", "1", "1", "v" });
            dT_03.Rows.Add(new Object[] { "1", "sprawy wielotomowe", "1", "1", "v" });
            dT_03.Rows.Add(new Object[] { "1", "o wyrok łączny", "1", "1", "v" });
            dT_03.Rows.Add(new Object[] { "1", "w trybie art..335 kpk", "1", "1", "v" });

            dT_03.Rows.Add(new Object[] { "1", "w trybie art..336 kpk", "1", "1", "v" });
            dT_03.Rows.Add(new Object[] { "1", "sprawy wielotomowe", "1", "1", "v" });



            dT_03.Rows.Add(new Object[] { "2", "K", "1", "2", "h" });
            dT_03.Rows.Add(new Object[] { "2", "w tym", "3", "1", "h" });
            dT_03.Rows.Add(new Object[] { "2", "Ko", "1", "2", "h" });

            dT_03.Rows.Add(new Object[] { "2", "RAZEM (r.3,7)", "1", "2", "h" });

            dT_03.Rows.Add(new Object[] { "2", "K", "1", "2", "h" });
            dT_03.Rows.Add(new Object[] { "2", "w tym K", "4", "1", "h" });
            ...
            dT_03.Rows.Add(new Object[] { "3", "Liczba załatwionych spraw na rozprawie", "6", "1", "h" });
            dT_03.Rows.Add(new Object[] { "3", "Liczba załatwionych spraw na posiedzeniach ", "8", "1", "h" });

            dT_03.Rows.Add(new Object[] { "3", "RAZEM (r.9,14-16)", "1", "3", "v" });

            dT_03.Rows.Add(new Object[] { "3", " załatwiono spraw ogółem (r.8+17)", "1", "3", "v" });
            ...
            dT_04.Rows.Add(new Object[] { "3", "Terminowość sporządzania uzasadnień", "4", "2" });
            ...
            dT_05.Rows.Add(new Object[] { "2", "K", "1", "1" });

            dT_05.Rows.Add(new Object[] { "2", "Ko", "1", "1" });
            dT_05.Rows.Add(new Object[] { "2", "Kp", "1", "1" });

            dT_05.Rows.Add(new Object[] { "2", "Kop", "1", "1" });

            dT_05.Rows.Add(new Object[] { "3", "Sprawy wg Ksiąg", "2", "2" });
            dT_05.Rows.Add(new Object[] { "3", "Liczba załatwionych  spraw od początku roku", "4", "1" });
        ...
        protected void makeHeader4(System.Web.UI.WebControls.GridView sender, DataTable dT)
        {
            try
            {
                ...
                foreach (DataRow dR in dT.Rows)
                {
                    ...
                    HeaderCell.Style.Clear();
                    HeaderCell.ApplyStyle(stl);
                    HeaderGridRow.Cells.Add(tb.HeaderCell_(dR[1].ToString().Trim(), int.Parse(dR[2].ToString().Trim()), int.Parse(dR[3].ToString().Trim())));
        ...
        protected void GridView2_RowCreated(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                tb.makeHeader((DataTable)Session["header_01"], GridView2);
        ...
        protected void GridView3_RowCreated(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                tb.makeHeader((DataTable)Session["header_03"], GridView3);
            }
        }
        ...
        protected void makeLabels()
        {
            try
            {
                ...
                {
                    // cały miesiąc
                    Label19.Text = " Liczba sesji i wyznaczonych spraw za miesiąc " + strMonthName + " " + Date2.Date.Year.ToString() + " roku.";
                    ...
                    Label5.Text = "Informacja statystyczna z ruchu spraw  karnych za miesiąc:  " + strMonthName + " " + Date2.Date.Year.ToString() + " roku.";
                    //Pozostało z ubieglego miesiąca
                    Label2.Text = "V.Liczba załatwionych spraw od początku roku";
                }
                else
                {
                    Label19.Text = " Liczba sesji i wyznaczonych spraw a za okres od " + Date1.Text + " do  " + Date2.Text;
                    ...
                    Label5.Text = "Informacja statystyczna z ruchu spraw  karnych za okres od:  " + Date1.Text + " do  " + Date2.Text;
                    Label2.Text = "V.Liczba załatwionych spraw od początku roku";
                }
            }
            catch
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage MyExcel = new ExcelPackage(existingFile))
            {
                ...
                try
                {
                    ...
                    this.Response.AddHeader("Content-Disposition", "attachment;tenPlik=" + fNewFile.Name);
