    ...
    public partial class onsg : System.Web.UI.Page
    {
        ...
        protected void przemiel()
        {
            ...
            try
            {
                ...
                DataTable tabela1 = dr.generuj_dane_do_tabeli_wierszy2018(DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text), (string)Session["id_dzialu"], 6, 6, 23, tenPlik);
        ...
        protected void makeLabels()
        {
            try
            {
                ...
                {
                    // cały miesiąc
                    Label19.Text = "Wpływ za miesiąc " + strMonthName + " " + DateTime.Parse(Date2.Text).Year.ToString() + " roku.";
                    Label17.Text = "Załatwienia za miesiąc " + strMonthName + " " + DateTime.Parse(Date2.Text).Year.ToString() + " roku.";
                    ...
                    Label6.Text = "Pozostało na miesiąc następny z miesiąca:  " + strMonthName + " " + DateTime.Parse(Date2.Text).Year.ToString() + " roku.";
