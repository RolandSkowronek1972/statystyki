    ...
    public partial class obbc : System.Web.UI.Page
    {
        ...
        protected void tabela3()
        {
            ...
            try
            {
                ...
                DataTable tabelka01 = dr.generuj_dane_do_tabeli_wierszy2018(DateTime.Parse(Date1.Text), DateTime.Parse(Date2.Text), (string)Session["id_dzialu"], 4, 20, 20, tenPlik);
