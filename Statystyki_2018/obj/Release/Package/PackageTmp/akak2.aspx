<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="akak2.aspx.cs" Inherits="stat2018.akak2"  MaintainScrollPositionOnPostback="true" %>
              ...
              <table style="width: 100%;" cellpadding="0" cellspacing="0">
                  <tr>
                      <td align="center" colspan="3" valign="middle" class="auto-style3">
                        ...
                        <td align="center" colspan="6" class="auto-style3"><asp:Label ID="Label712" runat="server" Text="I instancja" Font-Bold="True" Font-Italic="True" Font-Size="Medium"></asp:Label></td>
                        <td align="center" class="auto-style3" style="width: 5px">&nbsp;</td>
                        <td align="center" colspan="9" class="auto-style3"><asp:Label ID="Label46" runat="server" Text="II instancja" Font-Bold="True" Font-Italic="True" Font-Size="Medium"></asp:Label></td>
                   ...
                   <tr>
                      <td colspan="3" align="center" style="border-style: solid; border-width: medium thin medium medium; border-color: #000000;" valign="middle">
                          <asp:Label ID="Label52" runat="server" Text="Sprawy wg ksiąg"></asp:Label></td>
                        <td style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center"><asp:Label ID="Label55" runat="server" Text="l.p."></asp:Label></td>
                        <td align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;"><asp:Label ID="Label98" runat="server" Text="K"></asp:Label></td>
                        <td align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;"><asp:Label ID="Label99" runat="server" Text="Kp"></asp:Label></td>
                        <td align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;"><asp:Label ID="Label100" runat="server" Text="Ko"></asp:Label></td>
                        <td align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;"><asp:Label ID="Label101" runat="server" Text="Kop"></asp:Label></td>
                        <td align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;"><asp:Label ID="Label60" runat="server" Text="Ogólem &lt;br/&gt;I instancja"></asp:Label></td>
                        <td align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;"><asp:Label ID="Label103" runat="server" Text="Ar"></asp:Label></td>
                     
                        <td align="center" style="border-width: thin; border-right-style: solid; border-left-style: solid; width: 5px;">&nbsp;</td>
                     
                        <td align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;"><asp:Label ID="Label104" runat="server" Text="Ka"></asp:Label></td>
                        <td style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center"><asp:Label ID="Label81" runat="server" Text="w tym wykroczeniowe"></asp:Label></td>
                        <td style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center"><asp:Label ID="Label82" runat="server" Text="Kz"></asp:Label></td>
                        <td style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center"><asp:Label ID="Label714" runat="server" Text="w tym wykroczeniowe"></asp:Label></td>
                        <td style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center"><asp:Label ID="Label84" runat="server" Text="Kzw"></asp:Label></td>
                        <td style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center"><asp:Label ID="Label85" runat="server" Text="Ko"></asp:Label></td>
                        <td style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;" align="center"><asp:Label ID="Label86" runat="server" Text="WKK"></asp:Label></td>
                        <td align="center" style="border-style: solid; border-width: medium thin medium thin; border-color: #000000;"><asp:Label ID="Label112" runat="server" Text="Wykaz S &lt;br/&gt; sądowe"></asp:Label></td>
                        <td align="center" style="border-style: solid; border-width: medium medium medium thin; border-color: #000000;"><asp:Label ID="Label715" runat="server" Text="Wykaz S &lt;br/&gt;Prokuratorskie"></asp:Label></td>
                                           
                        <td align="center" style="border-style: solid; border-width: medium medium medium thin; border-color: #000000;"><asp:Label ID="Label716" runat="server" Text="OGÓŁEM II instancja"></asp:Label></td>
                   ...
                   <tr>
                      <td colspan="3" style="border-style: solid; border-width: 0px 0px 1px medium; border-color: #000000;" align="center">
                        ...
                        <td style="border-width: thin; width: 5px; border-right-style: solid; border-left-style: solid;" align="center"> &nbsp;</td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px 1px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=1!1!14!3')"><asp:Label CssClass="normal" ID="LB_115" runat="server" Text="0"></asp:Label></a> </td>
                        <td align="center" style="border-style: solid; border-width: 0px 1px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=1!1!15!3')"><asp:Label CssClass="normal" ID="LB_116" runat="server" Text="0"></asp:Label></a> </td>
                                           
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=1!1!15!3')"><asp:Label CssClass="normal" ID="LB_117" runat="server" Text="0"></asp:Label></a> </td>
                   ...
                   <tr>
                      <td rowspan="3" style="border-style: solid; border-width: 0px 0px 1px medium; border-color: #000000;" align="center">
                        ...
                        <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=2!1!13!3')"><asp:Label CssClass="normal" ID="LB_214" runat="server" Text="0"></asp:Label></a></td>
                        <td align="center" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=1!1!14!3')"><asp:Label CssClass="normal" ID="LB_215" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=2!1!15!3')"><asp:Label CssClass="normal" ID="LB_217" runat="server" Text="0"></asp:Label></a></td>
                   ...
                   <tr>
                        ...
                        <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=3!1!13!3')"><asp:Label CssClass="normal" ID="LB_314" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=3!1!15!3')"><asp:Label CssClass="normal" ID="LB_317" runat="server" Text="0"></asp:Label></a></td>
                   ...
                   <tr>
                        ...
                        <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=4!1!13!3')"><asp:Label CssClass="normal" ID="LB_414" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=4!1!15!3')"><asp:Label CssClass="normal" ID="LB_4_17" runat="server" Text="0"></asp:Label></a></td>
                   ...
                   <tr>
                      ...
                      <td colspan="2" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000;" align="center"><asp:Label ID="Label227" runat="server" Text="razem" Font-Bold="True"></asp:Label></td>
                       ...
                       <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=5!1!1!3')"><asp:Label CssClass="normal" ID="LB_52" runat="server" Text="0"></asp:Label></a> </td>
                        ...
                        <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=5!1!13!3')"><asp:Label CssClass="normal" ID="LB_514" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=5!1!15!3')"><asp:Label CssClass="normal" ID="LB_517" runat="server" Text="0"></asp:Label></a></td>
                   ...
                   <tr>
                      <td colspan="2" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000;" align="center"><asp:Label ID="Label251" runat="server" Text="w tym przekazano &lt;br/&gt;do innej jednostki"></asp:Label></td>
                        ...
                        <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=6!1!13!3')"><asp:Label CssClass="normal" ID="LB_614" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=6!1!15!3')"><asp:Label CssClass="normal" ID="LB_617" runat="server" Text="0"></asp:Label></a></td>
                   ...
                   <tr>
                      ...
                      <td colspan="2" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000;" align="center"><asp:Label ID="Label275" runat="server" Text="razem" Font-Bold="True"></asp:Label></td>
                        ...
                        <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=7!1!13!3')"><asp:Label CssClass="normal" ID="LB_714" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=7!1!15!3')"><asp:Label CssClass="normal" ID="LB_717" runat="server" Text="0"></asp:Label></a></td>
                   ...
                   <tr>
                      <td rowspan="3" style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000;" align="center"><asp:Label ID="Label299" runat="server" Text="w tym"></asp:Label></td>
                        ...
                        <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=8!1!13!3')"><asp:Label CssClass="normal" ID="LB_814" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=8!1!15!3')"><asp:Label CssClass="normal" ID="LB_817" runat="server" Text="0"></asp:Label></a></td>
                   ...
                   <tr>
                        ...
                        <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=9!1!13!3')"><asp:Label CssClass="normal" ID="LB_914" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=9!1!15!3')"><asp:Label CssClass="normal" ID="LB_917" runat="server" Text="0"></asp:Label></a></td>
                   ...
                   <tr>
                        ...
                        <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=10!1!13!3')"><asp:Label CssClass="normal" ID="LB_1014" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=10!1!15!3')"><asp:Label CssClass="normal" ID="LB_1017" runat="server" Text="0"></asp:Label></a></td>
                         </tr>
                   <tr>
                      <td class="auto-style2" colspan="3" style="border-style: solid; border-width: 0px 0px 1px medium; border-color: #000000;" align="center">
                       ...
                       <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=11!1!1!3')"><asp:Label CssClass="normal" ID="LB_11_1" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=11!1!13!3')"><asp:Label CssClass="normal" ID="LB_1114" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=11!1!15!3')"><asp:Label CssClass="normal" ID="LB_1117" runat="server" Text="0"></asp:Label></a></td>
                   ...
                   <tr>
                      <td colspan="3" style="border-style: solid; border-width: 0px 0px 1px medium; border-color: #000000;" align="center">
                       ...
                       <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=12!1!1!3')"><asp:Label CssClass="normal" ID="LB_122" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=12!1!13!3')"><asp:Label CssClass="normal" ID="LB_1214" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=12!1!15!3')"><asp:Label CssClass="normal" ID="LB_1217" runat="server" Text="0"></asp:Label></a></td>
                   ...
                   <tr>
                      <td colspan="3" style="border-style: solid; border-width: 0px 0px 1px medium; border-color: #000000;" align="center">
                       ...
                       <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=13!1!1!3')"><asp:Label CssClass="normal" ID="LB_132" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td style="border-style: solid; border-width: 0px 0px 1px 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=13!1!13!3')"><asp:Label CssClass="normal" ID="LB_1314" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin 1px 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=13!1!15!3')"><asp:Label CssClass="normal" ID="LB_1317" runat="server" Text="0"></asp:Label></a></td>
                   ...
                   <tr>
                      <td colspan="3" style="border-style: solid; border-width: 0px 1px medium medium; border-color: #000000;" align="center">
                        ...
                        <td style="border-style: solid; border-width: 0px 0px medium 1px; border-color: #000000; width: 56px;" align="center"><a href="javascript:openPopup('popup.aspx?sesja=14!1!13!3')"><asp:Label CssClass="normal" ID="LB_1414" runat="server" Text="0"></asp:Label></a></td>
                        ...
                        <td align="center" style="border-style: solid; border-width: 0px thin medium 1px; border-color: #000000; width: 56px;"><a href="javascript:openPopup('popup.aspx?sesja=14!1!15!3')"><asp:Label CssClass="normal" ID="LB_1417" runat="server" Text="0"></asp:Label></a></td>
  ...
  <ItemStyle  CssClass="col_103" />
   ...
   <div id="zalatwienia"  class="page-break"> 
    ...
    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
        DataSourceID="tabela_3" onrowcreated="GridView3_RowCreated" Width="100%" ShowHeader="False" OnSelectedIndexChanged="GridView3_SelectedIndexChanged" OnRowDataBound="GridView3_RowDataBound" ShowFooter="True">
        <Columns>
            <asp:BoundField DataField="id" HeaderText="L.p." SortExpression="id">
            <ItemStyle Width="15px" />
            </asp:BoundField>
...
&nbsp;
    &nbsp;<asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" 
     ...
     <asp:TemplateField HeaderText="d_06" SortExpression="d_06">
                ...
                <ItemTemplate>
                        <asp:TextBox ID="TextBox29" runat="server" Text='<%# Eval("d_21") %>' Width="30px"></asp:TextBox>
                </ItemTemplate>
                  <ItemStyle  CssClass="col_55" />
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="tabela_4" runat="server" 
        ...
        SelectCommand="SELECT ROW_NUMBER() OVER (ORDER BY ident) AS id, ident, imie, nazwisko, funkcja, stanowisko, d_01, d_02, d_03, d_04, d_05, d_06, d_07, d_08, d_09, d_10, d_11, d_12, d_13, d_14, d_15, d_16, d_17, d_18, d_19, d_20, d_21, d_22, d_23, d_24, sesja, id_sedziego, id_tabeli FROM tbl_statystyki_tbl_02 WHERE (id_tabeli = 4) AND (id_dzialu = @id_dzialu) ORDER BY id">
        <SelectParameters>
            <asp:SessionParameter Name="id_dzialu" SessionField="id_dzialu" />
        </SelectParameters>
    </asp:SqlDataSource>
