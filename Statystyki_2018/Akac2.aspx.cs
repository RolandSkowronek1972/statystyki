    ...
    public partial class Akac2 : System.Web.UI.Page
    {
        ...
        protected void odswiez()
        {
            ...
            try
            {
                ...
                LB_01_02.Text = tabelka01.Rows[0][2].ToString().Trim();
                LB_01_03.Text = tabelka01.Rows[0][3].ToString().Trim();
                LB_01_04.Text = tabelka01.Rows[0][4].ToString().Trim();
                LB_01_05.Text = tabelka01.Rows[0][5].ToString().Trim();
                LB_01_06.Text = tabelka01.Rows[0][6].ToString().Trim();
                LB_01_07.Text = tabelka01.Rows[0][7].ToString().Trim();
                LB_01_08.Text = tabelka01.Rows[0][8].ToString().Trim();
                LB_01_09.Text = tabelka01.Rows[0][9].ToString().Trim();
                LB_01_10.Text = tabelka01.Rows[0][10].ToString().Trim();
                LB_01_10.Text = tabelka01.Rows[0][11].ToString().Trim();
                LB_01_12.Text = tabelka01.Rows[0][12].ToString().Trim();
                LB_01_13.Text = tabelka01.Rows[0][13].ToString().Trim();
                LB_01_14.Text = tabelka01.Rows[0][14].ToString().Trim();
                LB_01_15.Text = tabelka01.Rows[0][15].ToString().Trim();
                LB_01_16.Text = tabelka01.Rows[0][16].ToString().Trim();
                LB_01_17.Text = tabelka01.Rows[0][17].ToString().Trim();
                LB_01_18.Text = tabelka01.Rows[0][18].ToString().Trim();
                LB_01_19.Text = tabelka01.Rows[0][19].ToString().Trim();
                //row 2
                ...
                //row11
                LB_11_01.Text = tabelka01.Rows[10][1].ToString().Trim();
                LB_11_02.Text = tabelka01.Rows[10][2].ToString().Trim();
                LB_11_03.Text = tabelka01.Rows[10][3].ToString().Trim();
                LB_11_04.Text = tabelka01.Rows[10][4].ToString().Trim();
                LB_11_05.Text = tabelka01.Rows[10][5].ToString().Trim();
                LB_11_06.Text = tabelka01.Rows[10][6].ToString().Trim();
                LB_11_07.Text = tabelka01.Rows[10][7].ToString().Trim();
                LB_11_08.Text = tabelka01.Rows[10][8].ToString().Trim();
                LB_11_09.Text = tabelka01.Rows[10][9].ToString().Trim();
                LB_11_10.Text = tabelka01.Rows[10][10].ToString().Trim();
                LB_11_11.Text = tabelka01.Rows[10][11].ToString().Trim();
                LB_11_12.Text = tabelka01.Rows[10][12].ToString().Trim();
                LB_11_13.Text = tabelka01.Rows[10][13].ToString().Trim();
                LB_11_14.Text = tabelka01.Rows[10][14].ToString().Trim();
                LB_11_15.Text = tabelka01.Rows[10][15].ToString().Trim();
                LB_11_16.Text = tabelka01.Rows[10][16].ToString().Trim();
                LB_11_17.Text = tabelka01.Rows[10][17].ToString().Trim();
                LB_11_18.Text = tabelka01.Rows[10][18].ToString().Trim();
                LB_11_19.Text = tabelka01.Rows[10][19].ToString().Trim();
            ...
            try
            {
                ...
                infoLabel6.Visible = cl.debug(int.Parse(yyx));
            }
            catch
            {
        ...
        protected void makeHeader()
        {
            ...
            dT_04.Rows.Add(new Object[] { "1", "rozprawy", "1", "1", "v" });
            dT_04.Rows.Add(new Object[] { "1", "posiedzenia", "1", "1", "v" });
            dT_04.Rows.Add(new Object[] { "1", "Ca", "1", "1" });
            dT_04.Rows.Add(new Object[] { "1", "Cz", "1", "1" });

            dT_04.Rows.Add(new Object[] { "1", "RAZEM (r.3+4)", "1", "1" });
            dT_04.Rows.Add(new Object[] { "1", "ilość spraw odroczonych na rozprawie", "1", "1", "v" });
            dT_04.Rows.Add(new Object[] { "1", "% odroczeń", "1", "1", "v" });
            dT_04.Rows.Add(new Object[] { "1", "w tym ilość odroczń publikacji orzeczeń", "1", "1", "v" });
            dT_04.Rows.Add(new Object[] { "1", "ilość spraw odroczonych na posiedzeniu", "1", "1", "v" });
            dT_04.Rows.Add(new Object[] { "1", "Ca", "1", "1" });
            dT_04.Rows.Add(new Object[] { "1", "Cz", "1", "1" });
            dT_04.Rows.Add(new Object[] { "1", "Co", "1", "1" });
            dT_04.Rows.Add(new Object[] { "1", "WSC", "1", "1" });

            dT_04.Rows.Add(new Object[] { "1", "Wykaz S", "1", "1" });

            dT_04.Rows.Add(new Object[] { "1", "RAZEM  (r.10-14)", "1", "1" });
            dT_04.Rows.Add(new Object[] { "1", "rozprawy", "1", "1" });
            dT_04.Rows.Add(new Object[] { "1", "posiedzenia", "1", "1" });
            dT_04.Rows.Add(new Object[] { "1", "Ca", "1", "1" });
            dT_04.Rows.Add(new Object[] { "1", "Cz", "1", "1" });
            ...
            dT_04.Rows.Add(new Object[] { "1", "RAZEM  (r.6-10)", "1", "1" });

            dT_04.Rows.Add(new Object[] { "2", "L.p.", "1", "2" });
            dT_04.Rows.Add(new Object[] { "2", "Imie i nazwisko sędziego", "1", "2" });
            dT_04.Rows.Add(new Object[] { "2", "Liczba wyznaczonych sesji - wokandy ", "2", "1" });
            dT_04.Rows.Add(new Object[] { "2", "Liczba wyznaczonych spraw na rozprawę ", "3", "1" });
            dT_04.Rows.Add(new Object[] { "2", "Odroczenia ", "4", "1" });
            dT_04.Rows.Add(new Object[] { "2", "Liczba wyznaczonych spraw na posiedzenie ", "6", "1" });
            dT_04.Rows.Add(new Object[] { "2", "Wyznaczono spraw ogółem (r.5+15) ", "1", "2" });
            dT_04.Rows.Add(new Object[] { "2", "Liczba odbytych sesji - wokandy ", "2", "1" });
            dT_04.Rows.Add(new Object[] { "2", "Liczba załatwionych spraw  na rozprawie", "3", "1" });
            dT_04.Rows.Add(new Object[] { "2", "Liczba załatwionych spraw na posiedzeniach", "6", "1" });
            dT_04.Rows.Add(new Object[] { "2", "Załatwiono spraw ogółem (r.5+11)", "1", "2" });
            ...
            dT_05.Rows.Add(new Object[] { "1", "1-14 dni", "1", "1", "v" });
            dT_05.Rows.Add(new Object[] { "1", "%", "1", "1", "v" });
            dT_05.Rows.Add(new Object[] { "1", "w tym nieuspra-<br/>wiedliwione", "1", "1", "h" });
            dT_05.Rows.Add(new Object[] { "1", "15-30 dni", "1", "1" });

            dT_05.Rows.Add(new Object[] { "1", "%", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "w tym nieuspra-<br/>wiedliwione", "1", "1", "h" });
            dT_05.Rows.Add(new Object[] { "1", "pow. 1 do 3 mies.", "1", "1", "v" });
            dT_05.Rows.Add(new Object[] { "1", "%", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "w tym nieuspra-<br/>wiedliwione", "1", "1", "h" });

            dT_05.Rows.Add(new Object[] { "1", "pownad 3 mies.", "1", "1", "v" });
            dT_05.Rows.Add(new Object[] { "1", "%", "1", "1" });
            dT_05.Rows.Add(new Object[] { "1", "w tym nieuspra-<br/>wiedliwione", "1", "1", "h" });

            dT_05.Rows.Add(new Object[] { "1", "1-14 dni", "1", "1", "v" });
            dT_05.Rows.Add(new Object[] { "1", "15-30 dni", "1", "1", "v" });
            dT_05.Rows.Add(new Object[] { "1", "1-3 m-cy", "1", "1", "v" });

            dT_05.Rows.Add(new Object[] { "1", "pow.3 m-cy", "1", "1", "v" });
            dT_05.Rows.Add(new Object[] { "1", "L", "1", "1", "v" });
            dT_05.Rows.Add(new Object[] { "1", "%", "1", "1" });

            dT_05.Rows.Add(new Object[] { "2", "ilość sporządzonych uzasadnień ogółem", "1", "2" });
            dT_05.Rows.Add(new Object[] { "2", "w  terminie ustawowym", "1", "2" });
            dT_05.Rows.Add(new Object[] { "2", "po upływie terminu ustawowego", "12", "1" });


            dT_05.Rows.Add(new Object[] { "3", "L.p.", "1", "3" });
            dT_05.Rows.Add(new Object[] { "3", "Imie i nazwisko sędziego", "1", "3" });
            dT_05.Rows.Add(new Object[] { "3", "Terminowość sporządzania uzasadnień", "14", "1" });
            dT_05.Rows.Add(new Object[] { "3", "Uzasadnienie wygłoszone art. 328 par. 1 kpc", "1", "3", "v" });
            dT_05.Rows.Add(new Object[] { "3", "Liczba wniosków o trankrypcje uzasadnień wygłoszonych w trybie art.. 328 par. 1 kpc", "1", "3" });
            dT_05.Rows.Add(new Object[] { "3", "zaległe uzasadnienia nie sporządzone mimo upływu terminu", "4", "2" });
            dT_05.Rows.Add(new Object[] { "3", "liczba spraw,  w których niewniesiono środka zaskażenia ", "2", "2" });
            dT_05.Rows.Add(new Object[] { "3", "liczba dni nieobecności w pracy (zwolnienia, urlopy…) w danym miesiącu", "1", "3" });
            ...
            dT_06.Rows.Add(new Object[] { "1", "Ca", "1", "1" });
            dT_06.Rows.Add(new Object[] { "1", "Cz", "1", "1" });
            dT_06.Rows.Add(new Object[] { "1", "Co", "1", "1" });
            dT_06.Rows.Add(new Object[] { "1", "WSC", "1", "1" });
            dT_06.Rows.Add(new Object[] { "1", "Wykaz S", "1", "1" });
            dT_06.Rows.Add(new Object[] { "1", "RAZEM  (r.1-5)", "1", "1" });
        ...
        protected void makeLabels()
        {
            try
            {
                ...
                else
                {
                    ...
                    tabela3Label.Text = "Liczba odbytych sesji i załatwionych spraw  za okres od" + Date1.Text + " do  " + Date2.Text;
                    tabela4Label.Text = " Liczba sesji, wyznaczonych i załatwionych spraw w II instancji za okres od " + Date1.Text + " do  " + Date2.Text;
                    Label5.Text = "Informacje o ruchu sprawa cywilnych za okres od:  " + Date1.Text + " do  " + Date2.Text;
                    tabela5Label.Text = "IV Terminowość sporządzania uzasadnień, absencja za okres od:  " + Date1.Text + " do  " + Date2.Text;
                    tabela6Label.Text = " Liczba załatwionych spraw od początku roku";
                }
            }
            catch
        ...
        {
            string path = Server.MapPath("Template") + "\\akac2.xlsx";
            FileInfo existingFile = new FileInfo(path);

            string download = Server.MapPath("Template") + @"\akac2";
            ...
            using (ExcelPackage MyExcel = new ExcelPackage(existingFile))
            {
                ...
                for (int i = 1; i < 22; i++)
                {
                    ...
                    MyWorksheet.Cells[20, i + 3].Value = sumObject.ToString();
                }
                ...
                MyWorksheet2.Cells[rowik + 7, 3].Style.Border.BorderAround(OfficeOpenXml.Style.ExcelBorderStyle.Thin, System.Drawing.Color.Black);
                MyWorksheet2.Cells[rowik + 7, 2].Style.Border.BorderAround(OfficeOpenXml.Style.ExcelBorderStyle.Thin, System.Drawing.Color.Black);
                MyWorksheet2.Cells[rowik + 7, 1].Style.Border.BorderAround(OfficeOpenXml.Style.ExcelBorderStyle.Thin, System.Drawing.Color.Black);
                ...
                for (int i = 1; i < 30; i++)
                {
                    ...
                    manageCells(MyWorksheet2, rowik + 7, i + 3, sumObject.ToString());
                }
                ...
                foreach (DataRow dR in table2.Rows)
                {
                    ...
                    for (int i = 3; i < 30; i++)
                    {
                        manageCells(MyWorksheet3, rowik + 7, i + 2, dR[i].ToString().Trim());
                    }
                    rowik++;
                }
                MyWorksheet3.Cells[rowik + 7, 3].Style.Border.BorderAround(OfficeOpenXml.Style.ExcelBorderStyle.Thin, System.Drawing.Color.Black);
                MyWorksheet3.Cells[rowik + 7, 2].Style.Border.BorderAround(OfficeOpenXml.Style.ExcelBorderStyle.Thin, System.Drawing.Color.Black);
                MyWorksheet3.Cells[rowik + 7, 1].Style.Border.BorderAround(OfficeOpenXml.Style.ExcelBorderStyle.Thin, System.Drawing.Color.Black);
                ...
                for (int i = 3; i < 30; i++)
                {
                    object sumObject;
                    string txt = "d_";
                    string digit = (i - 2).ToString("D2");
                    txt = txt + digit;
                    sumObject = table2.Compute("Sum(" + txt + ")", "");
                    manageCells(MyWorksheet3, rowik + 7, i + 2, sumObject.ToString());
                }
                ...
                foreach (DataRow dR in table3.Rows)
                {
                    ...
                    for (int i = 3; i < 31; i++)
                    {
                        if (i >= 19)
                        {
                            manageCells(MyWorksheet4, rowik + 6, i + 1, dR[i].ToString().Trim());
                        }
                        else
                        {
                            manageCells(MyWorksheet4, rowik + 6, i, dR[i].ToString().Trim());
                        }
                ...
                for (int i = 3; i < 31; i++)
                {
                    ...
                    if (i >= 19)
                    {
                        manageCells(MyWorksheet4, rowik + 6, i + 1, sumObject.ToString());
                    }
                    else
                    {
                        manageCells(MyWorksheet4, rowik + 6, i, sumObject.ToString());
                    }
                ...
                {
                    MyWorksheet5.Cells[rowik + 6, 1].Style.Border.BorderAround(OfficeOpenXml.Style.ExcelBorderStyle.Thin, System.Drawing.Color.Black);
                    ...
                    MyWorksheet5.Cells[rowik + 6, 1].Value = rowik.ToString();
                    MyWorksheet5.Cells[rowik + 6, 2].Value = dR[1].ToString().Trim() + " " + dR[2].ToString().Trim();


                    for (int i = 3; i < 26; i++)
                    {
                        manageCells(MyWorksheet5, rowik + 6, i, dR[i].ToString().Trim());
                    }
                    rowik++;
                }
                MyWorksheet5.Cells[rowik + 6, 1].Style.Border.BorderAround(OfficeOpenXml.Style.ExcelBorderStyle.Thin, System.Drawing.Color.Black);
                ...
                MyWorksheet5.Cells[rowik + 7, 2].Value = "Razem";
                for (int i = 3; i < 26; i++)
                {
                    object sumObject;
                    string txt = "d_";
                    string digit = (i - 2).ToString("D2");
                    txt = txt + digit;
                    sumObject = table4.Compute("Sum(" + txt + ")", "");

                    manageCells(MyWorksheet5, rowik + 6, i, sumObject.ToString());
                ...
                DataView view5 = (DataView)tabela_4.Select(DataSourceSelectArguments.Empty);
                DataTable table5 = view5.ToTable();
                table5.Columns.Remove("ident");
                table5.Columns.Remove("id_sedziego");
                table5.Columns.Remove("stanowisko");
                table5.Columns.Remove("funkcja");


                rowik = 1;
                foreach (DataRow dR in table5.Rows)
                {
                    MyWorksheet6.Cells[rowik + 6, 1].Style.Border.BorderAround(OfficeOpenXml.Style.ExcelBorderStyle.Thin, System.Drawing.Color.Black);
                    MyWorksheet6.Cells[rowik + 6, 2].Style.Border.BorderAround(OfficeOpenXml.Style.ExcelBorderStyle.Thin, System.Drawing.Color.Black);

                    MyWorksheet6.Cells[rowik + 6, 1].Value = rowik.ToString();
                    MyWorksheet6.Cells[rowik + 6, 2].Value = dR[1].ToString().Trim() + " " + dR[2].ToString().Trim();


                    for (int i = 3; i < 9; i++)
                    {
                        manageCells(MyWorksheet6, rowik + 6, i - 1, dR[i].ToString().Trim());
                    }
                    rowik++;
                }
                MyWorksheet6.Cells[rowik + 6, 1].Style.Border.BorderAround(OfficeOpenXml.Style.ExcelBorderStyle.Thin, System.Drawing.Color.Black);
                ...
                MyWorksheet6.Cells[rowik + 7, 2].Value = "Razem";
                for (int i = 3; i < 9; i++)
                {
                    object sumObject;
                    string txt = "d_";
                    string digit = (i - 2).ToString("D2");
                    txt = txt + digit;
                    sumObject = table5.Compute("Sum(" + txt + ")", "");

                    manageCells(MyWorksheet6, rowik + 6, i - 1, sumObject.ToString());
