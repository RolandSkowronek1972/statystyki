...
namespace stat2018
{
    public partial class aopcN : System.Web.UI.Page
    {
        ...
        private void debug()
        {
            ...
            try
            {
                string idTabeli = (string)Session["id_dzialu"];
                infoLabel1.Visible = cl.debug(int.Parse(idTabeli));
            }
            catch
            {
        ...
        protected void tworzPlikExcell(object sender, EventArgs e)
        {
            ...
            using (ExcelPackage MyExcel = new ExcelPackage(existingFile))
            {
                ...
                MyWorksheet1 = tb.tworzArkuszwExcle(MyExcel.Workbook.Worksheets[1], tabela, 149, 0, 9, true, false, false, false, false);
        ...
        {
            string idTabeli = "5";
            if (cl.debug(int.Parse(idTabeli)))
            {
                cm.log.Info(tenPlik + ": rozpoczęcie tworzenia tabeli 1");
            }
            DataTable tabelka01 = DevExpressXXL.zLicznikiemKolumn(dr.konwertujNaPrzecinek(dr.generuj_dane_do_tabeli_sedziowskiej_2019(int.Parse((string)Session["id_dzialu"]), 5, Date1.Date, Date2.Date, 150, tenPlik)));
            ...
            GridViewDataTextColumn kolumna_d02 = (DevExpressXXL.kolumnaDoTabeli("Ogółem", "d_02", idTabeli, "", false, szerokoscKolumny));
            GridViewDataTextColumn kolumna_d03 = DevExpressXXL.kolumnaDoTabeli("ogółem", "d_03", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d04 = DevExpressXXL.kolumnaDoTabeli("o <br/>rozwód", "d_04", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d05 = DevExpressXXL.kolumnaDoTabeli("o <br/>separację", "d_05", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d06 = DevExpressXXL.kolumnaDoTabeli("Ns ogółem", "d_06", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d07 = DevExpressXXL.kolumnaDoTabeli("w tym <hl><br/>Ns separacje", "d_07", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d08 = DevExpressXXL.kolumnaDoTabeli("Ns - rej", "d_08", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d09 = DevExpressXXL.kolumnaDoTabeli("Nc", "d_09", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d10 = DevExpressXXL.kolumnaDoTabeli("Co ogółem", "d_10", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d11 = DevExpressXXL.kolumnaDoTabeli("Co (wnioski o zwoln. od kosztów sąd. i ustanow. pełnom. przed złożeniem pozwu", "d_11", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d12 = DevExpressXXL.kolumnaDoTabeli("Co- nadawanie klauzuli wykonalności orzeczeniu sądu zagranicznego+ (skład 3-os)", "d_12", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d13 = DevExpressXXL.kolumnaDoTabeli("Co (do spraw pr. zakończonych)", "d_13", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d14 = DevExpressXXL.kolumnaDoTabeli("WSC", "d_14", idTabeli, "", false, szerokoscKolumny);
            ...
            GridViewDataTextColumn kolumna_d15 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_15", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d16 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_16", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d17 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_17", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d18 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_18", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d19 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_19", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d20 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_20", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d21 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_21", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d22 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_22", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d23 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_23", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d24 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_24", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d25 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_25", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d26 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_26", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d27 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_27", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d28 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_28", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d29 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_29", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d30 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_30", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d31 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_31", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d32 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_32", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d33 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_33", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d34 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_34", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d35 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_35", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d36 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_36", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d37 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_37", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d38 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_38", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d39 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_39", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d40 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_40", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d41 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_41", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d42 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_42", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d43 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_43", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d44 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_44", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d45 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_45", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d46 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_46", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d47 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_47", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d48 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_48", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d49 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_49", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d50 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_50", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d51 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_51", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d52 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_52", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d53 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_53", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d54 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_54", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d55 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_55", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d56 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_56", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d57 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_57", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d58 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_58", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d59 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_59", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d60 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_60", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d61 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_61", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d62 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_62", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d63 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_63", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d64 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_64", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d65 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_65", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d66 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_66", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d67 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_67", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d68 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_68", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d69 = DevExpressXXL.kolumnaDoTabeli("na rozprawę", "d_69", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d70 = DevExpressXXL.kolumnaDoTabeli("na posiedzenie", "d_70", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d71 = DevExpressXXL.kolumnaDoTabeli("Ogółem", "d_71", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d72 = DevExpressXXL.kolumnaDoTabeli("ogółem", "d_72", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d73 = DevExpressXXL.kolumnaDoTabeli("o rozwód", "d_73", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d74 = DevExpressXXL.kolumnaDoTabeli("o separację", "d_74", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d75 = DevExpressXXL.kolumnaDoTabeli("ogółem", "d_75", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d76 = DevExpressXXL.kolumnaDoTabeli("o rozwód", "d_76", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d77 = DevExpressXXL.kolumnaDoTabeli("o rozwód", "d_77", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d78 = DevExpressXXL.kolumnaDoTabeli("o rozwód", "d_78", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d79 = DevExpressXXL.kolumnaDoTabeli("o rozwód", "d_79", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d80 = DevExpressXXL.kolumnaDoTabeli("Ns", "d_80", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d81 = DevExpressXXL.kolumnaDoTabeli("Ns-rej", "d_81", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d82 = DevExpressXXL.kolumnaDoTabeli("Nc", "d_82", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d83 = DevExpressXXL.kolumnaDoTabeli("Co", "d_83", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d84 = DevExpressXXL.kolumnaDoTabeli("WSC", "d_84", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d85 = DevExpressXXL.kolumnaDoTabeli("Ogółem", "d_85", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d86 = DevExpressXXL.kolumnaDoTabeli("Rozprawy", "d_86", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d87 = DevExpressXXL.kolumnaDoTabeli("Posiedzenia", "d_87", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d88 = DevExpressXXL.kolumnaDoTabeli("ogółem", "d_88", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d89 = DevExpressXXL.kolumnaDoTabeli("Rozprawy", "d_89", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d90 = DevExpressXXL.kolumnaDoTabeli("Posiedzenia", "d_90", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d91 = DevExpressXXL.kolumnaDoTabeli("ogółem (wszystkie kategorie spraw)", "d_91", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d92 = DevExpressXXL.kolumnaDoTabeli("C", "d_92", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d93 = DevExpressXXL.kolumnaDoTabeli("Ns", "d_93", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d94 = DevExpressXXL.kolumnaDoTabeli("z teminem", "d_94", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d95 = DevExpressXXL.kolumnaDoTabeli("bez wyznaczonego terminu", "d_95", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d96 = DevExpressXXL.kolumnaDoTabeli("OGÓŁEM (wraz z publikacją orzeczeń)", "d_96", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d97 = DevExpressXXL.kolumnaDoTabeli("Ogółem", "d_97", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d98 = DevExpressXXL.kolumnaDoTabeli("ogółem", "d_98", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d99 = DevExpressXXL.kolumnaDoTabeli("o rozwód", "d_99", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d100 = DevExpressXXL.kolumnaDoTabeli("o separację", "d_100", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d101 = DevExpressXXL.kolumnaDoTabeli("ogółem", "d_101", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d102 = DevExpressXXL.kolumnaDoTabeli("o rozwód", "d_102", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d103 = DevExpressXXL.kolumnaDoTabeli("o separację", "d_103", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d104 = DevExpressXXL.kolumnaDoTabeli("o rozwód", "d_104", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d105 = DevExpressXXL.kolumnaDoTabeli("o separację", "d_105", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d106 = DevExpressXXL.kolumnaDoTabeli("Ns", "d_106", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d107 = DevExpressXXL.kolumnaDoTabeli("Ns-rej", "d_107", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d108 = DevExpressXXL.kolumnaDoTabeli("Nc", "d_108", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d109 = DevExpressXXL.kolumnaDoTabeli("Co", "d_109", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d110 = DevExpressXXL.kolumnaDoTabeli("WSC", "d_110", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d111 = DevExpressXXL.kolumnaDoTabeli("Ogółem", "d_111", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d112 = DevExpressXXL.kolumnaDoTabeli("zakreślonych", "d_112", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d113 = DevExpressXXL.kolumnaDoTabeli("niezakreślonych", "d_113", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d114 = DevExpressXXL.kolumnaDoTabeli("Ogółem", "d_114", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d115 = DevExpressXXL.kolumnaDoTabeli("do 3 mies.", "d_115", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d116 = DevExpressXXL.kolumnaDoTabeli("pow. 3 do 6 m - cy", "d_116", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d117 = DevExpressXXL.kolumnaDoTabeli("pow. 6 do 12 m - cy", "d_117", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d118 = DevExpressXXL.kolumnaDoTabeli("pow. 12 m-cy do 2 lat", "d_118", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d119 = DevExpressXXL.kolumnaDoTabeli("pow. 2 do 3 lat", "d_119", idTabeli, "", false, szerokoscKolumny);

            GridViewDataTextColumn kolumna_d_120 = DevExpressXXL.kolumnaDoTabeli("pow. 3 do 5 lat", "d_120", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_121 = DevExpressXXL.kolumnaDoTabeli("pow. 5 do 8 lat", "d_121", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_122 = DevExpressXXL.kolumnaDoTabeli("pow. 8 lat", "d_122", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_123 = DevExpressXXL.kolumnaDoTabeli("łącznie", "d_123", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_124 = DevExpressXXL.kolumnaDoTabeli("w terminie ustawowym 14 dni", "d_124", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_125 = DevExpressXXL.kolumnaDoTabeli("razem po terminie ustawowym", "d_125", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_126 = DevExpressXXL.kolumnaDoTabeli("nieuspra - wiedliwione", "d_126", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_127 = DevExpressXXL.kolumnaDoTabeli("1-14 dni", "d_127", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_128 = DevExpressXXL.kolumnaDoTabeli("w tym nieuspra - wiedliwione", "d_128", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_129 = DevExpressXXL.kolumnaDoTabeli("15-30 dni", "d_129", idTabeli, "", false, szerokoscKolumny);

            GridViewDataTextColumn kolumna_d_130 = DevExpressXXL.kolumnaDoTabeli("w tym nieuspra - wiedliwione", "d_130", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_131 = DevExpressXXL.kolumnaDoTabeli("powyżej 1 do 3 mies.", "d_131", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_132 = DevExpressXXL.kolumnaDoTabeli("w tym nieuspra - wiedliwione", "d_132", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_133 = DevExpressXXL.kolumnaDoTabeli("ponad 3 mies", "d_133", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_134 = DevExpressXXL.kolumnaDoTabeli("w tym nieuspra - wiedliwione", "d_134", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_135 = DevExpressXXL.kolumnaDoTabeli("ogółem", "d_135", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_136 = DevExpressXXL.kolumnaDoTabeli("w których wpłynął wniosek o transkrypcję", "d_136", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_137 = DevExpressXXL.kolumnaDoTabeli("razem", "d_137", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_138 = DevExpressXXL.kolumnaDoTabeli(" w których projekt został zaakceptowany przez sędziego", "d_138", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_139 = DevExpressXXL.kolumnaDoTabeli("wpływ", "d_139", idTabeli, "", false, szerokoscKolumny);

            GridViewDataTextColumn kolumna_d_140 = DevExpressXXL.kolumnaDoTabeli("ogółem", "d_140", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_141 = DevExpressXXL.kolumnaDoTabeli("uwzględniono", "d_141", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_142 = DevExpressXXL.kolumnaDoTabeli("pozostałość", "d_142", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_143 = DevExpressXXL.kolumnaDoTabeli("liczba spraw, w których strony skierowano do mediacji", "d_143", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_144 = DevExpressXXL.kolumnaDoTabeli("iczba ugód zawartych przed mediatorem", "d_144", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_145 = DevExpressXXL.kolumnaDoTabeli("ogółem", "d_145", idTabeli, "gray", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_146 = DevExpressXXL.kolumnaDoTabeli("w tym : w których wpłynął wniosek o transkrypcję", "d_146", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_147 = DevExpressXXL.kolumnaDoTabeli("razem", "d_147", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_148 = DevExpressXXL.kolumnaDoTabeli("w tym, w których projekt został zaakceptowany przez sędziego", "d_148", idTabeli, "", false, szerokoscKolumny);
            GridViewDataTextColumn kolumna_d_149 = DevExpressXXL.kolumnaDoTabeli("wpływ", "d_149", idTabeli, "", false, szerokoscKolumny);
