<%@ Page Title="" Language="C#" UICulture="pl" Culture="pl-PL" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="aopc2stary.aspx.cs" Inherits="stat2018.aopc2stary" %>
    ...
    <asp:BoundField DataField = "id" HeaderText = "L.p." SortExpression = "id" >
       ...
       <asp:TemplateField HeaderText = "d_98" SortExpression = "d_01" > 
          ...
          <a href = "javascript:openPopup('popup.aspx?sesja=<%# Eval("id_sedziego")+ "!"+Eval("id_tabeli") +"!98!6"%>')" ><asp:Label ID = "Label_tabela1198" runat = "server" Text = '<%# Eval("d_98")%>' CssClass = "normal" ></asp:Label> </a>
                   ...
                   <ItemStyle  CssClass = "col_80_fest_fest borderAll_fest"/>
                </asp:TemplateField>
